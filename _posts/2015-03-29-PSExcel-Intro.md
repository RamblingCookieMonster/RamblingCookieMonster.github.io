...
When I first started using PowerShell, I was more comfortable sending data to Excel, where I could comfortably filter, sort, and work with data. One of my first functions was a modification of a Export-XLSX found out on the Internet. That same code sits in a few places in production today; looking at old code is scary.
