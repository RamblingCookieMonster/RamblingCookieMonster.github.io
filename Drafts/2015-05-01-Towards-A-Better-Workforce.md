...
* **Lend a hand**. Don't do their work for them, but partner with their teams to build a solution that will illustrate how beneficial scripting and automation can be. Lead them through the pseudocode and thought process that goes on as you design a solution. Slowly put together that solution while trying to impart some knowledge around the language and technologies you are working with. Focus on encouraging them and try motivating them to continue using scripting for other solutions.
...
* **Highlight situations where scalability and consistency are critical**. There are many situations where you literally have no choice but to script something out.
...
There are likely more and better ways to convince management of the need to hire and keep problem solvers who can automate and design consistent, scalable solutions, rather than click-next laggards.
...
From my perspective, this is the most challenging problem. Sure, they are inefficient curmudgeons that are a detriment to the business on a whole, but they are often your friends. Maybe you've met their families at the occasional work related social events.
